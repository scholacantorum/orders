...
export default {
  ...
  async mounted() {
    ...
    this.payreq = stripe.paymentRequest({
      ...
      total: { label: 'Schola Cantorum Gala Registration', amount: 100, pending: true },
  ...
  methods: {
    ...
    onPRButtonClick(evt) {
      ...
      this.payreq.update({ total: { label: 'Schola Cantorum Gala Registration', amount: this.total, pending: false } })
    },
    async submit() {
