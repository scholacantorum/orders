export default function (o) {
  ...
  o.lines.forEach((ol, idx) => {
    ...
    fd.append(`${prefix}.used`, ol.used)
    fd.append(`${prefix}.usedAt`, ol.usedAt)
  })
  fd.append('payment1.type', o.payments[0].type)
  fd.append('payment1.subtype', o.payments[0].subtype)
  fd.append('payment1.method', o.payments[0].method)
